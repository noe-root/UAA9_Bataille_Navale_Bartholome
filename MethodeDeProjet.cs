...
{
    public class MethodeDeProjet
    {
        // ===== FONCTION PRINCIPALE DE LA BATAILLE =====
        // Cette fonction gère toute la partie de jeu (tirs alternés)
        public static void JouerBataille(string[,] grilleJ1, string[,] grilleJ2, string[,] tirsJ1, string[,] tirsJ2, int largeur, int hauteur)
        {
        ...
        public static void Tirer(string[,] grilleAdversaire, string[,] grilleTirs, string nomJoueur)
        {
        ...
        public static bool BateauCoule(string[,] grille, char symboleBateau)
        {
        ...
        public static string ObtenirNomBateau(char symbole)
        {
        ...
        public static bool TousLesBateauxCoules(string[,] grille)
        {
            int hauteur = grille.GetLength(0); // Obtenir le nombre de lignes
            int largeur = grille.GetLength(1); // Obtenir le nombre de colonnes
        ...
        public static void RemplirGrille(string[,] grille)
        {
            int hauteur = grille.GetLength(0); // Obtenir le nombre de lignes
            int largeur = grille.GetLength(1); // Obtenir le nombre de colonnes
        ...
        public static void AfficherGrille(int largeur, int hauteur, string[,] grille)
        {
        ...
        public static bool PlacerBateau(string[,] grille, string coordonnee, TypeBateau typeBateau, bool horizontal)
        {
            // ===== VALIDATION DE LA COORDONNÉE =====
            if (coordonnee.Length < 2)
            {
        ...
        public static char ObtenirSymboleBateau(TypeBateau type)
        {
        ...
        public static void PlacerTousLesBateaux(string[,] grille, string nomJoueur)
        {
        ...
        public static void AfficherInfosBateaux()
        {
